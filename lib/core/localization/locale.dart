...
class AppStrings {
  ...
  static const Map<String, String> en = {
    ...
    // Auth / guest / Request Assistance
    'logInTitle': 'Welcome back',
    'logInNote': 'Log in with the email and password you signed up with',
    'emailLabel': 'Email',
    'passwordLabel': 'Password',
    'loading': 'Please wait…',
    'continueAsGuest': 'Continue as Guest',
    'contactNameLabel': 'Name',
    'contactRelationLabel': 'Relation',
    'saveWord': 'Save',
    'noContactsSaved': 'Add emergency contacts in your profile so SOS can reach them.',
    'requestAssistanceTitle': 'Request Assistance',
    'assistanceRequestsTitle': 'Assistance Requests',
    'requestAssistanceIntro': 'Ask a nearby volunteer for help — not for emergencies (use SOS for those).',
    'requestTypeLabel': 'What do you need help with?',
    'requestTypeBoarding': 'Help boarding',
    'requestTypeGuidance': 'Guidance at station',
    'requestTypeOther': 'Other',
    'requestNoteLabel': 'Note (optional)',
    'requestNotePlaceholder': 'Add any extra detail for the volunteer',
    'submitRequest': 'Request help',
    'noActiveRequest': "You don't have an active request.",
    'requestStatusPending': 'Waiting for a volunteer',
    'requestStatusAccepted': 'Volunteer assigned',
    'requestStatusCompleted': 'Completed',
    'requestStatusCancelled': 'Cancelled',
    'volunteerOnTheWay': 'is on the way',
    'cancelRequestBtn': 'Cancel request',
    'myAcceptedRequestTitle': 'My accepted request',
  ...
  static const Map<String, String> si = {
    ...
    'logInNote': 'ඔබ ලියාපදිංචි වූ විද්‍යුත් තැපෑල සහ මුරපදය සමඟ පිවිසෙන්න',
    'emailLabel': 'ඊමේල්',
    'passwordLabel': 'මුරපදය',
    'loading': 'රැඳී සිටින්න...',
    'continueAsGuest': 'ආගන්තුකයෙකු ලෙස ඉදිරියට යන්න',
    'contactNameLabel': 'නම',
    'contactRelationLabel': 'සම්බන්ධතාවය',
    'saveWord': 'සුරකින්න',
    'noContactsSaved': 'SOS හදිසි සම්බන්ධතාවලට ළඟාවීමට ඔබේ පැතිකඩේ හදිසි සම්බන්ධතා එක් කරන්න.',
    'requestAssistanceTitle': 'සහාය ඉල්ලන්න',
    'assistanceRequestsTitle': 'සහාය ඉල්ලීම්',
    'requestAssistanceIntro':
        'ආසන්නයේ සිටින ස්වේච්ඡා සේවකයෙකුගෙන් උදව් ඉල්ලන්න — හදිසි අවස්ථා සඳහා SOS භාවිත කරන්න.',
    'requestTypeLabel': 'ඔබට කුමන උදව්වක් අවශ්‍යද?',
    'requestTypeBoarding': 'නැගීමට උදව්',
    'requestTypeGuidance': 'ස්ථානයේ මගපෙන්වීම',
    'requestTypeOther': 'වෙනත්',
    'requestNoteLabel': 'සටහන (විකල්ප)',
    'requestNotePlaceholder': 'ස්වේච්ඡා සේවකයා සඳහා අමතර විස්තර එක් කරන්න',
    'submitRequest': 'උදව් ඉල්ලන්න',
    'noActiveRequest': 'ඔබට සක්‍රීය ඉල්ලීමක් නැත.',
    'requestStatusPending': 'ස්වේච්ඡා සේවකයෙකු සඳහා රැඳී සිටී',
    'requestStatusAccepted': 'ස්වේච්ඡා සේවකයෙකු පවරා ඇත',
    'requestStatusCompleted': 'සම්පූර්ණයි',
    'requestStatusCancelled': 'අවලංගු කරන ලදී',
    'volunteerOnTheWay': 'එමින් සිටී',
    'cancelRequestBtn': 'ඉල්ලීම අවලංගු කරන්න',
    'myAcceptedRequestTitle': 'මගේ පිළිගත් ඉල්ලීම',
    'markCompleteBtn': 'සම්පූර්ණ කරන්න',
    'openRequestsTitle': 'විවෘත ඉල්ලීම්',
    'noOpenRequests': 'දැනට විවෘත ඉල්ලීම් නැත.',
    'acceptBtn': 'පිළිගන්න',
  };
